...
TRACKED_ENV_NAMES = (
    ...
    "INVOICE_SORTING_SMTP_HOST",
    "INVOICE_SORTING_SMTP_PORT",
    "INVOICE_SORTING_SMTP_USER",
    "INVOICE_SORTING_SMTP_PASSWORD",
    "INVOICE_SORTING_SMTP_FROM",
    "INVOICE_SORTING_SMTP_TLS",
    "INVOICE_SORTING_PUBLIC_BASE_URL",
    "INVOICE_SORTING_SIGNUP_NOTIFY_EMAILS",
    "INVOICE_SORTING_SECRET_KEY",
    "PYTHONPYCACHEPREFIX",
    "TZ",
)
ENV_SET = "已设置"
